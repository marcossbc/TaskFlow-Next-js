...
const WelcomePage = ({ tasks }: { tasks: Task[] }) => {
  ...
  return (
    // pl-14 moobaylka si badanka hamburger-ka uu boos ugu helo
    <div className="relative overflow-hidden rounded-2xl border border-gray-800/80 bg-gradient-to-r from-indigo-950/40 via-gray-900/40 to-purple-950/30 p-6 pl-14 md:pl-8 md:p-8 shadow-2xl backdrop-blur-xl w-full flex flex-col sm:flex-row justify-between items-start sm:items-center gap-5">
